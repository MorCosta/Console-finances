let finances = [
 ...
 //   console.log("Total: " + netTot);


 //finances[0][1]: la prima parentesi quadra rappresenta il numero della linea, e la seconda parentesi quadra rappresenta quale elemento viene selezionato
 ...
 avg = netTot / finances.length;

 console.log("Average change: " + avg.toFixed())
